...
CREATE TABLE `tblAuthor` (
  ...
  `AuthorName` varchar(1024) DEFAULT NULL,
...
CREATE TABLE `tblBook` (
  ...
  `BookFormat` tinyint(4) NOT NULL,
  `BookPubDate` datetime DEFAULT NULL,
...
INSERT INTO `tblBookFormat` VALUES (1,'Paperback'),(2,'Hardback'),(3,'eBook'),(4,'Graphic Novel'),(5,'Magazine'),(6,'Leatherbound');
...
-- Dump completed on 2011-10-20 13:12:12
